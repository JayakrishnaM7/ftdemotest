...
@Component
public class Partyrefdatadirectory implements JavaDelegate{

    @Autowired
    private Utility utility;

    @Autowired
    private PartyrefdatadirectoryRestProcessor restProcessor;

    private final static Logger LOGGER = Logger.getLogger(Partyrefdatadirectory.class.getName());
    ...
    public void execute(DelegateExecution execution) throws Exception {
         ...
         if(response instanceof ApiError ||  response instanceof GenericError){
            //Failure Path
            throw new RuntimeException("Error occurred in the adapter:"+Partyrefdatadirectory.class.getName());
         }else{
